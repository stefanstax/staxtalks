...
<div class="my-4 flex gap-[20px] flex-wrap justify-start items-center">
    ...
    ?>
        <div class="flex rounded-2xl bg-[<?php echo $SnowWhite; ?>] shadow-lg shadow-[<?php echo $BabyBlueShadow; ?>] p-4 w-full lg:w-5/12">
            <!-- Post Content -->
            <div class="w-full flex flex-wrap items-stretch justify-stretch min-h-[270px]">
                ...
                <!-- Post CTA -->
                <div class="w-full flex gap-[5px] justify-center items-center">
