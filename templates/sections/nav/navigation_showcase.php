...
<div class="hidden flex lg:flex fixed top-0 left-0 h-full drop-shadow-xl lg:<?php echo $NavigationWidthLarge; ?> bg-[<?php echo $MatteNavy; ?>] text-[<?php echo $Silver; ?>] flex justify-center items-center navigation__menu">
