  ...
  <div class="w-full h-full px-4 py-6 bg-[<?php echo $MatteBlack; ?>] text-[<?php echo $Silver; ?>] flex flex-col justify-between items-center drop-shadow-2xl">
    ...
    <?php if (!is_page("website-release") && !is_page("privacy-policy") && !is_page("terms-and-conditions") && !is_page("contact")) { ?>
      <div class="flex gap-[20px] max-w-[600px] w-full md:w-6/12 flex-wrap justify-center items-center h-full">
        <a href="https://instagram.com/staxtalks/" target="_blank" class="bg-[<?php echo $BabyBlue; ?>] text-[<?php echo $MatteBlack; ?>] hover:bg-[<?php echo $LightSilver; ?>] active:bg-[<?php echo $LightSilver; ?>] <?php echo $roundedFull; ?> p-2 text-center text-white w-full md:w-5/12">
        ...
        <a href="<?php echo site_url($contactUrl); ?>" class="bg-[<?php echo $BabyBlue; ?>] text-[<?php echo $MatteBlack; ?>] hover:bg-[<?php echo $LightSilver; ?>] active:bg-[<?php echo $LightSilver; ?>] <?php echo $roundedFull; ?>  p-2 text-center text-white w-full md:w-5/12">
          <span class="flex justify-center items-center">
