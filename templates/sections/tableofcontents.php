...
<div class="container flex flex-wrap w-fit justify-start xl:sticky xl:top-20 xl:right-6">
  ...
  <div class="tableOfContents hidden lg:flex flex-col border-l-[2px] border-[<?php echo $Silver; ?>] text-[<?php echo $MatteNavy; ?>] mb-8 p-4 lg:container xl:ml-[0em] xl:max-w-[300px]">
